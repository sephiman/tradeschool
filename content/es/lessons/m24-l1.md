...
- **Mover el stop a break-even, a veces.** Una vez que el precio ha hecho un nuevo mínimo más alto *por
  encima* de tu entrada (digamos que empuja a 62.300 y retrocede a un mínimo más alto en 61.200), la
  estructura ya te protege, así que subir el stop a break-even (60.300) es legítimo: sigues al gráfico.
  Hacerlo al primer parpadeo verde, antes de cualquier estructura nueva, es **miedo**: ahogas la
  operación por evitar una pérdida y te sacan por ruido a cambio de nada.
- **Salidas parciales.** Quitar algo en un hito (p. ej. la mitad en +2R, **62.300**) es una forma
  válida de asegurar avance y bajar la carga emocional del resto. También baja tu resultado medio, así
  que es una elección, no un regalo: decídelo en el plan, no en el momento.
...
break-even) y toca **64.000**. Salimos. Resultado: **+3,7R ≈ +370 USDT**, o un poco menos si tomamos un
parcial: una operación planificada y ejecutada.
